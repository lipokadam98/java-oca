...
//        Dog newDog = (Dog)cat; // class cast exception
        ...
        //A virtual method az egy olyan metódus amelyről nem derül ki pontosan a futási időig hogy pontosan mit is fog csinálni
        //Az Animal classban is van printDetails() viszont a Rabbit felül írja ezért a Rabbit classban lévő fog érvényesülni
    }
}
